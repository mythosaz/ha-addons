...
Long-running HTTP POST service for Home Assistant that bypasses shell_command timeout limits.
...
The add-on fires a `post_informer_complete` event when generation finishes:
...
```
[post_informer] Add-on started, waiting for input...
[post_informer] Generating image: model=gpt-image-1, quality=high, size=1536x1024
[post_informer] Prompt: A serene mountain landscape...
[post_informer] render_time_seconds: 12.34
[post_informer] Archived: /media/generated/202601040700-morning_postcard.png
[post_informer] Current: /media/generated/morning_postcard.png
[post_informer] Fired event post_informer_complete: 200
```
